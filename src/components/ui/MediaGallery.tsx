                    ...
                    {normalizedMedia.length > 1 && (
                        <>
                            <button 
                                ...
                                className="absolute left-10 top-1/2 -translate-y-1/2 w-20 h-20 bg-white/5 hover:bg-[var(--primary)] text-white/40 hover:text-white rounded-full flex items-center justify-center z-[1001] transition-all duration-500 backdrop-blur-3xl border border-white/10 hover:border-[var(--primary)] group shadow-2xl"
                            >
                                <ChevronLeft className="w-10 h-10 group-hover:-translate-x-1 transition-transform" />
                            </button>
                            <button 
                                onClick={goToNext} 
                                className="absolute right-10 top-1/2 -translate-y-1/2 w-20 h-20 bg-white/5 hover:bg-[var(--primary)] text-white/40 hover:text-white rounded-full flex items-center justify-center z-[1001] transition-all duration-500 backdrop-blur-3xl border border-white/10 hover:border-[var(--primary)] group shadow-2xl"
                            >
